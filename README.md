...
5. Тестировалось только с одним включенным ботом, как будет себя одноврменно с двумя не проверялось PS: Запускайте также 2 копии автоматики для каждого бота и пробуйте
